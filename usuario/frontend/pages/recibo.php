      ...
      <div class="recibo_content">
        <div class="recibo-complete">
          <div class="recibo-info">
            <div class="recibo_dir">
              <h3 class="dir_title">Elige una Dirección <a class="add_button" href="javascript:void(0);" data-toggle="modal" data-target="#add_dir" 
                onclick="carga_ajax('1','add_dir','modals/modal_add_dir.php');"> 
        ...
        <div class="recibo_inv">
          ...
          <div class="next_button">
            <a  onclick="crear_orden_compra('<?php echo $arre_tienda["cod_tie"];  ?>','<?php echo $total; ?>','<?php echo $del; ?>','<?php echo $arre_tienda["raz_tie"]; ?>','<?php echo $arre_tienda["cha_id_tie"]; ?>','<?php echo $_SESSION["nom_usu"]; ?>');" href="#" class="button-confir" >
