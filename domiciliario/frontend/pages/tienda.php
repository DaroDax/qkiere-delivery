  ...
  <!--<input type="submit" value="Subir" onclick="add_producto('<?php echo $arre_inv['cod_inv'];?>');">-->
        ...
        <?php } ?>
          ...
          <div class="fijo">
            ...
            <input type="number" placeholder ="Telefono Fijo" name="tel2_tie" id="tel2_tie" class="form-control" value="<?php echo  $arre_tienda["tel2_tie"]; ?>">
          </div>
          <div class="tel">
            ...
            <input type="number" placeholder="Telefono" name="tel_tie" id="tel_tie" class="form-control" value="<?php echo  $arre_tienda["tel_tie"]; ?>">
          </div>
          <div class="ema">
